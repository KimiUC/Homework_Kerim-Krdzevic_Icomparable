...
namespace DMV_GUI
{
    class MotorVehicle : IComparable
    {
        ...
        public static int count = 0; //integer count static
        public static string copyright = "Kerim Krdzevic"; //integer count static

        public int CompareTo(object other) //Compare function
        {
            return this.dateOfProduction.CompareTo(((MotorVehicle)other).dateOfProduction); //CompareTo function vehicles by dateOfProduction
        }
        ...
        public MotorVehicle(string VIN, string make, string model, int noOfWheels, int noOfSeats, DateTime dateOfProduction)
        {
            ...
            count++; //add count function for counting objects that are crated
        }

...
namespace MotorVehicle
{
    class Program
    {
        ...
        {
            List<DMV_GUI.MotorVehicle> list = new List<DMV_GUI.MotorVehicle>(); //Using list instead of plain fixed array
            ...
            foreach (DMV_GUI.MotorVehicle l in list)
                            {
                Console.WriteLine(l.show()); //Print information before sorting dateOfProduction
            }
            list.Sort(); //Sorts list
            Console.WriteLine("After sorting: ");
            foreach (DMV_GUI.MotorVehicle l in list)
            {
                Console.WriteLine(l.show()); //Print information after sorting
            }
        }
    }
}
